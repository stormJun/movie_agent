...
from api_common.dependencies import get_knowledge_graph_service
...
from api_common.schemas import (
    EntityData,
    EntityDeleteData,
    EntitySearchFilter,
    EntityUpdateData,
...
router = APIRouter(route_class=AdminRequestLoggingRoute, prefix="/api/v1", tags=["knowledge-graph-v1"])
