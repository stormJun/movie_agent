"""
Graph indexing package.

Phase2.5: keep this package importable in a core-only install (minimal deps).
Concrete index managers may require optional dependencies (vector stores, numpy, ...).
"""
...
_LAZY_IMPORTS: Dict[str, Tuple[str, str]] = {
    "ChunkIndexManager": ("graphrag_agent.graph.indexing.chunk_indexer", "ChunkIndexManager"),
    "EntityIndexManager": ("graphrag_agent.graph.indexing.entity_indexer", "EntityIndexManager"),
}
