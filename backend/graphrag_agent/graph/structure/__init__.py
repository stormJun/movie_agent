...
Concrete structure builders may require optional dependencies.
"""
...
_LAZY_IMPORTS: Dict[str, Tuple[str, str]] = {
    "GraphStructureBuilder": ("graphrag_agent.graph.structure.struct_builder", "GraphStructureBuilder"),
}
