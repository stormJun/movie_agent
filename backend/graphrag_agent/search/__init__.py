...
Optional runtime dependencies (langchain/numpy/pandas/neo4j/...) are required
only when importing the concrete implementations.
"""
...
def __getattr__(name: str) -> Any:
    ...
    try:
        ...
        # If the missing module is within our own package, this is a packaging/code
        # bug, not an optional-deps issue. Re-raise to make it obvious.
