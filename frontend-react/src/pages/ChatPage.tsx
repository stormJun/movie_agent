  ...
  useEffect(() => {
    getExampleQuestions()
      ...
      .catch((e) => {
        ...
        setExampleQuestions(["(示例加载失败，请检查后端 Migration)"]);
      });
  }, []);
  ...
  return (
    <Layout className="chat-container" style={{ height: "100vh" }}>
      ...
      <Layout.Sider
        width={chatSideWidth}
        theme="light"
        style={{ borderLeft: "1px solid #f0f0f0", background: "#fff" }}
        collapsible={false} // Right side not collapsible yet, or manual only
        trigger={null}
      >
        ...
        <Card title="示例问题" size="small" style={{ marginTop: 12 }}>
          <Space wrap>
