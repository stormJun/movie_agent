...
def get_knowledge_graph(limit: int = 100, query: str = None) -> Dict:
    ...
    try:
        ...
        response = requests.get(
            f"{API_URL}/api/v1/knowledge_graph",
            params=params,
            timeout=30
        )
...
def get_knowledge_graph_from_message(message: str, query: str = None):
    ...
    try:
        ...
        response = requests.get(
            f"{API_URL}/api/v1/knowledge_graph_from_message",
            params=params,
            timeout=30
        )
        result = response.json()
...
def get_source_file_info_batch(source_ids: list) -> dict:
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/source_info_batch",
...
def get_relation_types():
    ...
    try:
        response = requests.get(
            f"{API_URL}/api/v1/relation_types",
            timeout=10
        )
        result = response.json()
...
def get_entities(filters=None):
    ...
    try:
        ...
        response = requests.post(
            f"{API_URL}/api/v1/entities/search",
            json=filters,
            timeout=20
        )
        result = response.json()
...
def get_relations(filters=None):
    ...
    try:
        ...
        response = requests.post(
            f"{API_URL}/api/v1/relations/search",
            json=filters,
            timeout=20
        )
        result = response.json()
...
def create_entity(entity_data):
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/entity/create",
            json=entity_data,
            timeout=15
        )
        return response.json()
...
def update_entity(entity_data):
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/entity/update",
            json=entity_data,
            timeout=15
        )
        return response.json()
...
def delete_entity(entity_id):
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/entity/delete",
            json={"id": entity_id},
            timeout=15
        )
        return response.json()
...
def create_relation(relation_data):
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/relation/create",
            json=relation_data,
            timeout=15
        )
        return response.json()
...
def update_relation(relation_data):
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/relation/update",
            json=relation_data,
            timeout=15
        )
        return response.json()
...
def delete_relation(relation_data):
    ...
    try:
        response = requests.post(
            f"{API_URL}/api/v1/relation/delete",
            json=relation_data,
            timeout=15
        )
        return response.json()
...
def clear_chat():
    ...
    try:
        ...
        # 清除后端状态
        response = requests.post(
            f"{API_URL}/api/v1/clear",
            json={"user_id": st.session_state.user_id, "session_id": st.session_state.session_id}
        )
...
class ApiBatchProcessor:
    ...
    def _batch_get_content(self, chunk_ids):
        ...
        try:
            response = requests.post(
                f"{API_URL}/api/v1/content_batch",
