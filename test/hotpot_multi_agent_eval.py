...
if os.environ.get("GRAPHRAG_FORCE_NEO4J", "0") != "1":
    ...
    class _DummyDBManager:
        ...
        def query(self, _cypher: str, params=None):
            return []
    ...
    class _DummyNeo4jProvider:
        def __init__(self) -> None:
            self._db_manager = _DummyDBManager()
        ...
        def get_config(self):
            return {
                "uri": self._db_manager.neo4j_uri,
                "username": self._db_manager.neo4j_username,
                "password": self._db_manager.neo4j_password,
            }

    set_neo4j_provider(_DummyNeo4jProvider())
