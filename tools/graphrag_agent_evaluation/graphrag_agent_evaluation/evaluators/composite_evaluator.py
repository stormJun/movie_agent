...
from graphrag_agent_evaluation.evaluators.answer_evaluator import AnswerEvaluator
from graphrag_agent_evaluation.evaluators.retrieval_evaluator import (
...
class CompositeGraphRAGEvaluator:
    ...
    def __init__(self, config: Dict[str, Any] = None):
        ...
        try:
            from graphrag_agent_evaluation.metrics.graph_metrics import SubgraphQualityMetric
    ...
    def log(self, message, *args, **kwargs):
        ...
        Args:
            ...
            *args, **kwargs: 额外参数
        """
        from graphrag_agent_evaluation import debug_print
        if self.debug:
